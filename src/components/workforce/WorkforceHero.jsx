      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 text-left space-y-8">
            <div className="inline-flex items-center gap-2 bg-slate-800/80 border border-slate-700 backdrop-blur-md text-blue-400 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider shadow-lg">
              <ShieldCheck size={16} />
              <span>India's Largest Logistics Network</span>
            </div>

            <div className="space-y-6">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display font-extrabold text-white tracking-tight leading-[1.1]">
                Join GoMyTruck Workforce & <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-brand-400">
                  Earn Consistent Income
                </span>
              </h1>
              <p className="text-slate-300 font-medium text-lg sm:text-xl max-w-xl leading-relaxed">
                Start your career as a Delivery Executive, Driver, or Warehouse Helper. Get daily jobs, flexible hours, and guaranteed timely payouts.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-6 pt-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm">Directly to your bank</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-white font-semibold">Quick Onboarding</p>
                  <p className="text-slate-400 text-sm">Start working today</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-[2rem] p-6 sm:p-8 shadow-2xl shadow-black/50">
              {isRegistered ? (
                <div className="text-center py-12 space-y-6">
                  <div className="h-20 w-20 bg-blue-500/20 border border-blue-500/30 text-blue-400 rounded-full flex items-center justify-center mx-auto animate-bounce shadow-lg shadow-blue-500/20">
                    <BadgeCheck size={40} />
                  </div>
                  <div className="space-y-2">
                    ...
                    <p className="text-base text-slate-300 px-4 leading-relaxed">
                      Thank you, <span className="text-blue-400 font-semibold">{name}</span>. Our recruitment officer will call you on <span className="text-blue-400 font-semibold">+91 {phone}</span> shortly.
                    </p>
                  </div>
                  ...
                  <button 
                    ...
                    className="text-sm text-blue-400 hover:text-blue-300 font-bold underline transition-colors"
                  >
                ...
                <form onSubmit={handleRegister} className="space-y-5">
                  <div className="mb-6">
                    <h3 className="text-2xl font-display font-bold text-white tracking-tight">Join Our Workforce</h3>
                    <p className="text-sm text-slate-300 mt-2">Enter your details to start your journey with us.</p>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        type="text" placeholder="e.g. Ramesh Kumar" value={name}
                        onChange={(e) => setName(e.target.value)}
                        className="w-full bg-slate-900/50 border border-slate-700 rounded-xl py-3 px-4 text-white placeholder-slate-500 focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400 transition-all"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full bg-slate-900/50 border border-slate-700 rounded-xl py-3 pl-14 pr-4 text-white placeholder-slate-500 focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400 transition-all"
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          type="text" placeholder="e.g. Kolkata" value={city}
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full bg-slate-900/50 border border-slate-700 rounded-xl py-3 px-4 text-white focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400 transition-all cursor-pointer appearance-none"
                        >
                          <option className="bg-slate-800" value="Delivery Executive">Delivery Exec.</option>
                          <option className="bg-slate-800" value="Driver">Driver</option>
                          <option className="bg-slate-800" value="Helper/Loader">Helper/Loader</option>
                        </select>
                      </div>
                    </div>
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full mt-4 bg-blue-500 hover:bg-blue-400 text-white font-extrabold text-lg py-4 px-6 rounded-xl shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 hover:-translate-y-0.5 active:translate-y-0.5 transition-all flex items-center justify-center gap-2 group cursor-pointer"
                  >
